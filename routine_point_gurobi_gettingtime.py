...
for key, it in zip(instancias.keys(), range(len(instancias.keys()))):
    ...
    if size >= 5 and size <= 15: #and iter >= 127 + 63 + 62: #and iter >= 59: #and iter >= 45 + 19: #and iter >= 188 + 13:
        ...
        solution = MultiTargetPolygonal(datos, 1)
        ...
        dataframe.to_csv('results_point_gurobi_gettingtime.csv', header = True, mode = 'w')
