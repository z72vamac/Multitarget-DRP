...
%\draw [color=qqqqff] (64.16,63.04) node[anchor=north west]{$\bm{x_R^2=x_L^3}$};
...
\draw [color=qqqqff](17.46,51.55) node[anchor=north west] {\bm{$x_L^1$}};
\draw [fill=qqqqff] (42.66,70.1) circle (2.5pt);
\draw [color=qqqqff] (18.33,72.04) node[anchor=north west]{$\bm{x_R^1}$};
\draw [fill=qqqqff] (50.41,65.14) circle (2.5pt);
\draw [color=qqqqff] (50.33,71.04) node[anchor=north west]{$\bm{x_L^2}$};
\draw [fill=qqqqff] (86.83,57.18) circle (2.5pt);
\draw [color=qqqqff] (88.5,63.04) node[anchor=north west]{$\bm{x_R^2}$};
\end{scriptsize}
\end{axis}
\end{tikzpicture}
